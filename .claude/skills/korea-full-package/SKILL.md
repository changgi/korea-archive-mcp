...
- [ ] 입문 카드뉴스(키워드 정복형) — 후킹 문구·키워드 초대형 타이포·쉬운 설명(중학생 눈높이), 전 장 육안 검수
- [ ] 메시지형(미장센 문법) — 1장 1메시지·실물 미장센·서사 아크(충격→반전→블랙아웃→선언), 슬라이드판 발표 노트에 디렉팅 기록
- [ ] 기록 해설형 — 점선 영역 박스+외곽 번호 판독(내용 가림·점 찍기 금지, 레터박스 제거)·메타데이터 표·원판/사본 계보, 추정 금지(불명 표기), 보고서 부록 절 포함
- [ ] 시연 영상(선택) — 데모 GIF/MP4(로컬 demo-video 스킬 / 웹 연속 캡쳐 GIF), ZIP video/
